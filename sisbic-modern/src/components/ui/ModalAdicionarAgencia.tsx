    ...
    <Modal
      ...
      variant="glass"
          ...
          <label className="block text-sm font-medium mb-1">Agência</label>
                  ...
                  <div>
          <label className="block text-sm font-medium mb-1">Cotas</label>
                    <Controller
                        name="cotas"
                        control={control}
                        render={({ field }) => (
                ...
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-white/50 dark:bg-gray-700/50 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white sm:text-sm"
                min="1"
                            />
                        )}
                    />
