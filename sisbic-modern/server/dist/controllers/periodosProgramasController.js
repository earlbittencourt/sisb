...
exports.upsertProjetoConfiguracao = exports.getProjetoConfiguracao = exports.deleteAgenciaEdital = exports.adicionarAgenciaEdital = exports.updateAgenciaEdital = exports.listarAgenciasPorEdital = exports.deletePeriodoPrograma = exports.updatePeriodoPrograma = exports.getPeriodoProgramaById = exports.getPeriodosProgramas = void 0;
const database_1 = require("../config/database");
// Busca todos os períodos de programas com filtros opcionais
const getPeriodosProgramas = async (req, res) => {
    try {
        ...
        if (tipo && tipo !== 'all') {
            ...
            request.input('tipo', database_1.sql.Int, tipo);
        }
        if (status && status !== 'all') {
            whereClauses.push('p.PEP_Codigo_PPS = @status');
            request.input('status', database_1.sql.Int, status);
        }
...
exports.getPeriodosProgramas = getPeriodosProgramas;
// Busca um período de programa específico pelo ID
const getPeriodoProgramaById = async (req, res) => {
    const { id } = req.params;
    try {
        const pool = await (0, database_1.connectToDatabase)();
...
exports.getPeriodoProgramaById = getPeriodoProgramaById;
// Atualiza um período de programa
const updatePeriodoPrograma = async (req, res) => {
    const { id } = req.params;
    ...
    try {
        ...
        const setClause = Object.keys(fieldsToUpdate)
            ...
            if (key.includes('Codigo')) {
                sqlType = database_1.sql.Int;
            }
            else if (key.includes('Dt')) {
                sqlType = database_1.sql.Date;
            }
            else {
                sqlType = database_1.sql.NVarChar;
            }
        ...
        request.input('id', database_1.sql.Int, id);
...
exports.updatePeriodoPrograma = updatePeriodoPrograma;
// Deleta um período de programa
const deletePeriodoPrograma = async (req, res) => {
    const { id } = req.params;
    try {
        const pool = await (0, database_1.connectToDatabase)();
        await pool.request()
...
exports.listarAgenciasPorEdital = listarAgenciasPorEdital;
const updateAgenciaEdital = async (req, res) => {
    ...
    try {
        const pool = await (0, database_1.connectToDatabase)();
        await pool.request()
            .input('editalId', database_1.sql.Int, editalId)
            .input('agenciaId', database_1.sql.Int, agenciaId)
            .input('cotas', database_1.sql.Int, cotas)
            .query(`
...
exports.updateAgenciaEdital = updateAgenciaEdital;
// Adiciona uma agência a um edital
const adicionarAgenciaEdital = async (req, res) => {
...
exports.adicionarAgenciaEdital = adicionarAgenciaEdital;
// Deleta uma agência de um edital
const deleteAgenciaEdital = async (req, res) => {
    const { id: editalId, agenciaId } = req.params;
    try {
        const pool = await (0, database_1.connectToDatabase)();
...
exports.deleteAgenciaEdital = deleteAgenciaEdital;
// --- Funções para Configuração de Submissão ---
const getProjetoConfiguracao = async (req, res) => {
    const { id } = req.params;
    try {
        const pool = await (0, database_1.connectToDatabase)();
        const result = await pool.request()
...
exports.getProjetoConfiguracao = getProjetoConfiguracao;
const upsertProjetoConfiguracao = async (req, res) => {
    const { id: editalId } = req.params;
    ...
    try {
        ...
        await pool.request()
            .input('editalId', database_1.sql.Int, editalId)
            .input('PCF_nmProjetos', database_1.sql.Int, PCF_nmProjetos)
            .input('PCF_nmMinPlanos', database_1.sql.Int, PCF_nmMinPlanos)
            .input('PCF_nmPlanos', database_1.sql.Int, PCF_nmPlanos)
            .input('PCF_nmAvaliadores', database_1.sql.Int, PCF_nmAvaliadores)
            .query(query);
...
exports.upsertProjetoConfiguracao = upsertProjetoConfiguracao;
